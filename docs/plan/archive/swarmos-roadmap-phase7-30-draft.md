# ARCHIVED — swarmos-roadmap Phase 7 → 30 draft (superseded)

> **ARCHIVED 2026-06-26.** Original detailed Phase 7→30 draft that used to
> sit at the end of [`../swarmos-roadmap.md`](../swarmos-roadmap.md). It
> defined a *different* phase numbering (Phase 8 = autonomy engine, 9 =
> federation, 10 = ML) that collided with the canonical roadmap. Kept for
> history only — **do not use its order or numbering.** The active Phase 7+
> plan and numbering live in
