...
Payload control is intentionally not part of ``DroneAdapter``. Flight adapters
without non-flight hardware remain valid, while payload-capable units register
a controller under the same ``agent_id``.
"""
